...
<div class="item">
    ...
    <b><u class="padding-left-70"><a href="<?= $this->Url->build('/frontends/view/'.$product->id) ?>" style="color:white;"><?= h($product->name) ?></a></u></b>
...
<?php foreach ($news as $new): ?>
    <div class="col-md-8">
        <span class="color-blue font-size-17 "><b><a href=""><?=(__('THÔNG TIN SỨC KHỎE'))?></a></b></span>
        ...
        <span class="color-blue"><b class="font-size-40 padding-left-20">.</b></span><a href="<?= $this->Url->build('/frontends/news/'.$new->id) ?> "><?= h($new->name) ?></a><br>
